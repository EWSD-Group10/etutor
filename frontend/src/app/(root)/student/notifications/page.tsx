...
function getNotificationIcon(type: Notification["type"]) {
  const iconProps = { sx: { fontSize: 22, color: "white" } };
  switch (type) {
    case "tutor_assigned":
      return { icon: <PersonIcon {...iconProps} />, bg: "#1976d2" };
    ...
    default:
      return { icon: <NotificationsIcon {...iconProps} />, bg: "#1976d2" };
  }
}
    ...
    <>
      <Box
        ...
        sx={{
          ...
          "&:hover": {
            bgcolor: notification.isRead ? "white" : alpha("#1976d2", 0.02),
          },
          position: "relative",
        }}
      >
        ...
        <Box sx={{ flex: 1, minWidth: 0 }}>
          ...
          {/* Meeting details expansion for pending meetings */}
      ...
      >
        <Box>
          ...
          <Typography
            ...
            sx={{ fontWeight: 500 }}
          >
            Stay updated on allocations, meetings, and more
          </Typography>
        </Box>
        <Button
          variant="outlined"
