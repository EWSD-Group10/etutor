      ...
      <Table size="medium" sx={{ minWidth: 720 }}>
        <TableHead>
          <TableRow sx={{ bgcolor: alpha("#000", 0.02) }}>
            <TableCell sx={{ fontWeight: 700, color: "text.secondary", py: 2 }}>File Name</TableCell>
            <TableCell sx={{ fontWeight: 700, color: "text.secondary" }}>Format</TableCell>
            <TableCell sx={{ fontWeight: 700, color: "text.secondary" }}>Size</TableCell>
            <TableCell sx={{ fontWeight: 700, color: "text.secondary" }}>Uploaded By</TableCell>
            <TableCell sx={{ fontWeight: 700, color: "text.secondary" }}>Date</TableCell>
            <TableCell align="right" sx={{ fontWeight: 700, color: "text.secondary", pr: 2 }}>
              Actions
            </TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {rows.length === 0 ? (
            ...
            rows.map((row) => {
              const category: DocumentFormatCategory = getFormatCategory(row.fileName, row.fileFormat);
              ...
              return (
                <TableRow
                  key={row.id}
                  hover
                  sx={{ "&:last-child td": { borderBottom: 0 }, "& td": { py: 2 } }}
                >
                  <TableCell>
