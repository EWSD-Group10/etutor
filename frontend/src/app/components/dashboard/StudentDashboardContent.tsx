...
interface StudentDashboardContentProps {
  dashboardData: StudentDashboardPayload | null;
  dataLoading: boolean;
  headerLoading?: boolean;
  greetingName: string;
  /** Admin preview: hide deep links and primary actions. */
  previewMode?: boolean;
}
      ...
      <Grid container spacing={3}>
        <Grid size={{ xs: 12, md: 6 }}>
          <DashboardSection
            ...
            viewAllHref={previewMode ? undefined : "/student/documents"}
          >
            {dataLoading ? (
              <>
                {[...Array(3)].map((_, i) => (
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          <DashboardSection
            ...
            viewAllHref={previewMode ? undefined : "/student/blog"}
          >
            {dataLoading ? (
              <>
                {[...Array(3)].map((_, i) => (
